...
export async function savePageView(website_id, session_id, url, ref, referrer) {
  return runQuery(
...
export async function saveEvent(website_id, session_id, url, ref, event_type, event_value) {
  return runQuery(
    prisma.event.create({
      data: {
        website_id,
